        ...
        <main>
            <div class="mailform">
                <form action="submit.php" method="post">
                    ...
                    echo "<p>お名前：" . $username . "</p>";
                    echo "<p>メールアドレス：" . $mailadd . "</p>";
                    echo "<p>ご用件：" . $yoken . "</p>";
                    echo "<p>詳細：" . $mailtext . "</p>";

                    ?>
                    <input type="submit" class="sbm" value="送信">
                    
                    <input type="hidden" name="username" value="<?php echo $_POST['username']; ?>">
                    <input type="hidden" name="mailadd" value="<?php echo $_POST['mailadd']; ?>">
                    <input type="hidden" name="yoken" value="<?php echo $_POST['yoken']; ?>">
                    <input type="hidden" name="mailtext" value="<?php echo $_POST['mailtext']; ?>">
                           
                    <input type="button" class="sbm" value="戻って修正" onclick="history.back()">
                </form>
            </div>
        </main>
        <footer>
